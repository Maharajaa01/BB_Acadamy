...
export function AboutPage() {
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-14 md:py-16 overflow-hidden bg-academy-black text-white">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          ...
          <h1 className="text-3xl sm:text-4xl md:text-5xl font-heading font-bold mb-4 text-balance animate-fade-up delay-100">
            Empowering Students to{" "}
            <span className="text-academy-orange">Excel</span>
          </h1>
          <p className="text-base md:text-lg text-gray-300 max-w-2xl mx-auto text-pretty animate-fade-up delay-200 leading-relaxed">
            From a humble beginning to Chennai's premier tuition center, driven
            by passion and a commitment to making learning easy.
          </p>
        </div>
      </section>

      {/* Founder Section */}
      <section className="py-12 md:py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          <div className="relative animate-fade-up">
            ...
            <div className="absolute -bottom-6 -right-6 bg-white p-6 rounded-xl shadow-xl max-w-xs animate-scale-in delay-300 hidden md:block">
              <p className="font-heading font-bold text-lg text-academy-black">
          ...
          <div className="space-y-6 animate-fade-up delay-200">
            ...
            <div className="space-y-4 text-lg text-gray-600 leading-relaxed">
              <p>
                Started in 2016 with a burning passion for teaching, Mr. Tamil
                Selvan founded Black Building Academy with a simple mission:{" "}
                <strong>Make Learning Easy</strong>.
              </p>
              <p>
                He believes in motivating students not just through grades, but
                through appreciation. His unique philosophy includes rewarding
                students with gifts and constant encouragement.
              </p>
              <div className="p-4 bg-orange-50 border-l-4 border-academy-orange rounded-r-lg">
                <p className="font-medium text-academy-black italic">
                  "If a student excels in learning, I don't ask for fees. My
                  reward is their success."
                </p>
                <div className="mt-2 text-sm text-gray-500">
                  - Tamil Selvan's Philosophy
                </div>
              </div>
            </div>
      ...
      <section className="py-12 md:py-14 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-academy-black mb-8 md:mb-10 animate-fade-up">
            Life at BB Academy
          </h2>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            <div className="space-y-4 animate-fade-up delay-100">
              ...
              <div>
                <h3 className="text-xl font-bold text-academy-black">
                  Fun & Learning Combined
                </h3>
                <p className="text-gray-600 mt-2">
                  Engaging students with educational games to make studying
                  enjoyable.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 animate-fade-up delay-200">
              ...
              <div>
                <h3 className="text-xl font-bold text-academy-black">
                  Celebrating Excellence (VLP)
                </h3>
                <p className="text-gray-600 mt-2">
                  Recognizing 'Vera Level Performers' and awarding staff to keep
                  motivation high.
                </p>
              </div>
            </div>
            ...
            <div className="space-y-4 animate-fade-up delay-300">
              ...
              <div>
                <h3 className="text-xl font-bold text-academy-black">
                  Dedicated Night Study
                </h3>
                <p className="text-gray-600 mt-2">
                  Special coaching sessions for Quarterly Exams to ensure top
                  performance.
                </p>
              </div>
            </div>
      ...
      {/* Features Section */}
      <section className="py-12 md:py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-white">
        <div className="text-center mb-10 md:mb-12 animate-fade-up">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-academy-black mb-6">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-none shadow-lg glass animate-fade-up">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Our team of qualified educators brings extensive experience and
                dedication, fostering a supportive and enriching learning
                environment.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-none shadow-lg glass animate-fade-up delay-100">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                We prioritize student safety and well-being, creating a
                nurturing atmosphere that allows students to focus on their
                academic growth without distractions.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-none shadow-lg glass animate-fade-up delay-200">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                We are confident in our teaching methods and programs, helping
                students reach their full potential with a guaranteed pass in
                public exams.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-none shadow-lg glass animate-fade-up delay-300">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Regular assessments and detailed feedback through our
                Performance Report Card System enable effective progress
                monitoring.
              </p>
            </CardContent>
          </Card>
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-none shadow-lg glass animate-fade-up delay-400">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                BB Academy employs modern, competitive learning methods to
                encourage a healthy competitive spirit, driving students to
          ...
          <Card className="hover:shadow-xl transition-all duration-300 hover:-translate-y-2 border-none shadow-lg glass animate-fade-up delay-500">
            <CardContent className="p-8">
              ...
              <p className="text-gray-600 leading-relaxed">
                Batch-wise coaching and separate classes for boys and girls
                ensure focused attention tailored to individual needs.
              </p>
            </CardContent>
          </Card>
        </div>
      ...
      {/* Growth Timeline */}
      <section className="py-12 md:py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <h2 className="text-3xl md:text-4xl font-heading font-bold text-academy-black mb-10 md:mb-12 text-center animate-fade-up">
          Our Growth Story
        </h2>
        ...
        <div className="max-w-3xl mx-auto space-y-12 relative before:absolute before:inset-0 before:ml-5 md:before:ml-[50%] before:-translate-x-px md:before:mx-auto before:h-full before:w-0.5 before:bg-gradient-to-b before:from-transparent before:via-gray-300 before:to-transparent">
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group animate-fade-up">
            ...
            <Card className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 shadow-md hover:shadow-lg transition-all glass">
              <div className="flex items-center justify-between mb-2">
                <span className="font-bold text-2xl text-academy-orange">
                  2016
                </span>
                <Badge variant="outline">The Beginning</Badge>
              </div>
              <p className="text-gray-700">
                Started the journey with just{" "}
                <strong className="text-academy-black">3 employees</strong> and{" "}
                <strong className="text-academy-black">12 students</strong>. The
                vision was clear: Quality education for all.
              </p>
            </Card>
          </div>
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group animate-fade-up delay-100">
            ...
            <Card className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 shadow-md hover:shadow-lg transition-all glass">
              ...
              <p className="text-gray-700">
                The dedication paid off. We grew to{" "}
                <strong className="text-academy-black">50+ students</strong> and
                expanded our team to{" "}
                <strong className="text-academy-black">10 staff members</strong>
                .
              </p>
            </Card>
          </div>
          ...
          <div className="relative flex items-center justify-between md:justify-normal md:odd:flex-row-reverse group animate-fade-up delay-200">
            ...
            <Card className="w-[calc(100%-4rem)] md:w-[calc(50%-2.5rem)] p-6 shadow-md hover:shadow-lg transition-all glass border-academy-orange/20 bg-orange-50/50">
              ...
              <p className="text-gray-700">
                Currently empowering over{" "}
                <strong className="text-academy-black">500+ students</strong>{" "}
                with a dedicated team of{" "}
                <strong className="text-academy-black">50+ staff</strong>. We
                are now a landmark in education.
              </p>
            </Card>
          </div>
        </div>
      ...
      <section className="py-12 md:py-14 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-3xl md:text-4xl font-heading font-bold text-academy-black mb-8 animate-fade-up">
          ...
          <p className="mt-6 text-lg text-gray-600 max-w-2xl mx-auto animate-fade-up delay-200">
            The inspiring journey of Mr. Tamil Selvan and how he started Black
            Building Academy.
          </p>
        </div>
      </section>
      ...
      {/* FAQ Section */}
      <section className="py-12 md:py-14 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 bg-gray-50">
        <div className="max-w-3xl mx-auto">
          <div className="text-center mb-10 md:mb-12 animate-fade-up">
            ...
            <p className="text-gray-600 text-lg">
              Common questions about admissions and our coaching methods.
            </p>
          </div>
          ...
          <Accordion
            type="single"
            collapsible
            className="w-full space-y-4 animate-fade-up delay-100"
          >
            <AccordionItem
              value="item-1"
              className="bg-white rounded-xl border px-6 shadow-sm"
            >
              <AccordionTrigger className="text-lg font-semibold text-academy-black hover:text-academy-orange hover:no-underline">
                What standards/grades do you cover?
              </AccordionTrigger>
              <AccordionContent className="text-gray-600 text-base leading-relaxed">
                We provide expert coaching for students from 6th to 12th
                standard, covering State Board curriculum with specialized focus
                on 10th and 12th board exams.
              </AccordionContent>
            </AccordionItem>
            ...
            >
              <AccordionTrigger className="text-lg font-semibold text-academy-black hover:text-academy-orange hover:no-underline">
                Do you offer separate classes for boys and girls?
              </AccordionTrigger>
              <AccordionContent className="text-gray-600 text-base leading-relaxed">
                Yes, we ensure a comfortable learning environment by offering
                separate batches and classes for boys and girls to provide
            ...
            >
              <AccordionTrigger className="text-lg font-semibold text-academy-black hover:text-academy-orange hover:no-underline">
                How do you ensure student progress?
              </AccordionTrigger>
              <AccordionContent className="text-gray-600 text-base leading-relaxed">
                We use a comprehensive Performance Tracking System with regular
                report cards, daily attendance monitoring, and the unique 'Seal
                System' to track and improve student performance continuously.
              </AccordionContent>
            </AccordionItem>
          </Accordion>
        </div>
      ...
      <section className="py-16 bg-academy-black text-white overflow-hidden relative">
        ...
        <div className="container mx-auto px-4 relative z-10 grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
          <div className="animate-fade-up">
            <div className="text-4xl md:text-5xl font-bold text-academy-orange mb-2">
              500+
            </div>
