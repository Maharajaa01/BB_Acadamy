...
const perks = [
  {
    ...
    description:
      "Comprehensive coverage and wellness programs to keep you at your best.",
  },
  {
    icon: <GraduationCap className="w-6 h-6 text-blue-500" />,
    title: "Learning & Development",
    description:
      "Continuous learning opportunities, workshops, and career advancement.",
  },
  {
    icon: <Coffee className="w-6 h-6 text-yellow-600" />,
    title: "Great Work Environment",
    description:
      "Collaborative, supportive, and dynamic spaces designed for creativity.",
  },
  {
    icon: <Shield className="w-6 h-6 text-green-500" />,
    title: "Impact & Security",
    description:
      "Secure employment with the opportunity to profoundly impact student lives.",
  },
];
...
export function CareerPage() {
  ...
  return (
    <div className="min-h-screen bg-white">
      {/* Hero Section */}
      <section className="relative py-14 md:py-16 overflow-hidden bg-academy-black text-white flex flex-col justify-center items-center">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
          <p className="text-academy-orange font-semibold text-xs md:text-sm uppercase tracking-[0.18em] mb-3 animate-fade-up">
            Career
          </p>
          ...
          <p className="text-base md:text-lg text-gray-300 max-w-2xl mx-auto text-pretty animate-fade-up delay-200 mb-6 leading-relaxed">
            Build your career with Black Building Academy and help shape the
            future of education.
          </p>

          <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-7 animate-fade-up delay-300">
            <a
              href="/staff_.pdf"
          ...
          <div className="flex flex-wrap gap-3 md:gap-4 justify-center items-center text-sm md:text-base text-white font-medium animate-fade-up delay-300">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-12 md:mb-14 animate-fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Discover what it's like to work with us from the people who know
              it best.
            </p>
            <div className="w-24 h-1.5 bg-academy-orange mx-auto mt-6 rounded-full"></div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-10 md:gap-7 pt-4">
            {[
              {
                name: "Priya Sharma",
                role: "Senior Physics Teacher",
                quote:
                  "Working at BB Academy has been incredibly fulfilling. The support from management and the enthusiasm of students make every day rewarding.",
              ...
              },
              {
                ...
                quote:
                  "The emphasis on continuous learning and innovation here is what sets us apart. We don't just teach, we inspire students to excel.",
              ...
              },
              {
                ...
                quote:
                  "I love the collaborative culture. Everyone is genuinely invested in the well-being and success of our students and each other.",
                image: "/testimonial_3.png",
              },
            ].map((testimonial, index) => (
              <Card
                key={index}
                className="border-none shadow-xl hover:shadow-2xl transition-all duration-500 relative bg-white group animate-fade-up hover:-translate-y-2"
              ...
              >
                <CardContent className="pt-16 pb-8 px-8 text-center relative z-10">
                  ...
                  <h4 className="font-bold text-xl text-academy-black mb-1">
                    {testimonial.name}
                  </h4>
                  <p className="text-sm text-academy-orange font-semibold tracking-wide uppercase">
                    {testimonial.role}
                  </p>
                </CardContent>
      ...
      <section className="py-12 md:py-16 bg-gray-50 border-y border-gray-100 relative overflow-hidden">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
          <div className="text-center mb-10 md:mb-12 animate-fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              We care about our team. Discover the benefits and environment that
              make working with us a rewarding experience.
            </p>
            <div className="w-24 h-1.5 bg-academy-orange mx-auto mt-6 rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 md:gap-10 items-center">
            ...
            <div className="relative h-[500px] rounded-3xl overflow-hidden shadow-2xl animate-fade-up group">
              <Image
                src="/work_culture.png"
                alt="Work Culture at BB Academy"
                fill
              ...
              <div className="absolute bottom-8 left-8 right-8 text-white transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                ...
                <p className="text-white/90 text-lg">
                  A collaborative space where innovative ideas thrive and every
                  educator is valued.
                </p>
              </div>
            </div>
              ...
              {perks.map((perk, index) => (
                ...
                >
                  <CardContent className="p-6 text-left flex flex-col h-full">
                    ...
                    <h3 className="text-lg font-bold text-academy-black mb-2">
                      {perk.title}
                    </h3>
      ...
      <section className="py-12 md:py-16 bg-white relative">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-10 md:mb-12 animate-fade-up">
            ...
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
              Life at BB Academy is about more than just teaching. It's about
              celebrating success, building connections, and creating lasting
              memories.
            </p>
            <div className="w-24 h-1.5 bg-academy-orange mx-auto mt-6 rounded-full"></div>
          </div>
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4 md:gap-6 auto-rows-[200px] md:auto-rows-[250px]">
            {[
              {
                src: "/staff_group_photo.jpg",
                span: "col-span-2 row-span-2",
                alt: "Staff Group",
              },
              {
                src: "/teachers_making_centum.jpg",
                span: "col-span-2 md:col-span-1 row-span-1",
                alt: "Teachers Celebrating",
              },
              {
                src: "/students_group_photo.jpg",
              ...
              <div
                key={index}
                className={`relative rounded-3xl overflow-hidden group shadow-lg hover:shadow-2xl transition-all duration-500 ${img.span} animate-fade-up`}
      ...
      {/* Job Listings */}
      <section className="py-12 md:py-16 lg:py-18 bg-gray-50/50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                  ...
                  <CardContent>
                    ...
                    <Dialog>
                      ...
                      <DialogContent className="max-w-2xl max-h-[80vh] overflow-y-auto">
                        <DialogHeader>
                          <DialogTitle className="text-2xl font-bold text-academy-black">
                            {job.title}
                          </DialogTitle>
                        ...
                        <div className="space-y-6">
                          <div>
                            <h3 className="text-lg font-semibold text-academy-black mb-3">
                              Job Description
                            </h3>
                            <div
